<template>
  <DialogShell v-if="addressStore.addressDialogOpen" title="保單地址" @close="addressStore.closeAddressDialog">
      ...
      <section class="address-list-section">
        ...
        <div class="address-table">
          ...
          >
            ...
            <span>
              <strong
                >{{ address.addressTypeCode }} {{ addressStore.addressTypeCodeLabel(address.addressTypeCode) }}</strong
              >
