  ...
  it('displays the complete 002 main ride snapshot without a duplicate field row', () => {
    const detail: PolicyChangeCaseDetail = {
      changeCase: {
        ...
        changeItemCodes: '002',
        changeItemCodeDescriptions: '主約保額變更'
      },
      changedFieldNames: [
        {
          id: 1,
          ...
          changeCaseNo: 'C1150718008',
          changeItemCode: '002',
          changedFieldName: 'policy_coverage.000.insured_amount',
          chineseName: '保額',
          changedRecordKey: '000',
      ...
      changedRecordTypes: [
        {
          id: 10,
          changeSnapshotId: '019f0000-0000-7000-8000-000000000201',
          policyNo: 'P000000001',
          policySeq: 1,
          changeCaseNo: 'C1150718008',
          changeItemCode: '002',
          changedRecordType: 'policy_coverage',
          changedRecordKey: '000',
          contentBefore: null,
          contentAfter: null,
          snapshotFields: [
            ...
            { jsonKey: 'coverageItemType', chineseName: '主附約類型', contentBefore: '1', contentAfter: '1' },
            { jsonKey: 'coverageItemSeq', chineseName: '主附約序號', contentBefore: '000', contentAfter: '000' },
            { jsonKey: 'productCode', chineseName: '險種代碼', contentBefore: 'LIFE', contentAfter: 'LIFE' },
            { jsonKey: 'coverageTermYears', chineseName: '年期', contentBefore: '20', contentAfter: '20' },
            { jsonKey: 'insuredAmount', chineseName: '保額', contentBefore: '1000000', contentAfter: '1200000' },
            { jsonKey: 'premiumAmount', chineseName: '保費', contentBefore: '12345.6789', contentAfter: '12345.6789' }
          ],
          createdAt: null,
          updatedAt: null
        }
    ...
    expect(wrapper.text()).not.toContain('policy_coverage.000.insured_amount')
  })
})
